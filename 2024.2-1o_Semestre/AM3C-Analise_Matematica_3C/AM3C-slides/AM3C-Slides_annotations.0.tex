...
\begin{sectionBox}1m{Identidades Trigonométricas} % S2
  \begin{multicols}{2}
    \begin{align}
        \sin^2(x) + \cos^2(x) &= 1
      \\ 1 + \tan^2(x)         &= \sec^2(x)
...
\begin{sectionBox}1m{Trigonometria Hiperbólica} % S3
  \begin{multicols}{2}
    \begin{align}
...
\begin{sectionBox}1m{Tabela de Derivadas} % S4
  \begin{multicols}{2}
...
\begin{sectionBox}1m{Tabela de Integrais} % S6
  \subsection*{Basics}
  \begin{align}
       \int       \odif{u}    &= c + u 
