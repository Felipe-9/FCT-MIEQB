...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{Projeto 1 -- CGI}}
\newcommand\myauthor  {{Felipe B. Pinto 71951 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{CGI}}
\newcommand\mykeywords{{{Projeto 1},{WebGL},{Coding}}}
...
\begin{itemize}
  ...
  \item "=" or "+": + segmentos
  \item "-": - segmentos
  \item " ": toggle movement
  \item ">": increase velocity
  \item "<": decrease velocity
  \item "p" or "P": show points
  \item "l" or "L": show curves
  \item "1": draw B-SPline
  \item "2": draw catmulrom curve
  \item "3": draw bezier curve
  \item "4": set all current curves to selected curve type
\end{itemize}
\end{document}
