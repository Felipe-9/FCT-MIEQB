% !TEX root = ./Carta_de_Motivação.tex
...
\newcommand\mytitle   {{Carta de Motivação}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Carta de Motivação para a Vaga de Auxiliar de Investigação}}
\newcommand\mykeywords{{{Carta de Motivação}}}
...
Durante meu curso acadêmico obtive várias oportunidades de abranger meus conhecimentos e competencias, em destaque trabalhei previamente com Excel programando macros e funções em VBA, criando um programa que coleta, processa e apresenta um \textit{dashboard} interatívo com análises. Para alem durante o curso acadêmico pude aprender C, C++, Python e SQL e extendi meu repertório com linguas aprendidas autodidaticamente, são elas, \LaTeX, Lua, JavaScript e Git, alem de boa experiencia com design e estética para programas e documentos.

Possúo boa experiencia com trabalho em equipe dentro do meio acadêmico, mas acredito que experiencias de trabalho em equipe para alêm do campus universitário será uma experiencia bastante enriquecedor.\\

Acredito que com minhas competências possuo grande capacidade de elevar a apresentação e análize dos dados em meios técnologicos.\\

Agradeco antecipadamente a vossa melhor atenção.\\
