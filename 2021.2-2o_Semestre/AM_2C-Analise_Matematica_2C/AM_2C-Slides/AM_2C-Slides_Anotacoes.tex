...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{AM 2C -- Anotações Slides}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações dos slides de AM 2C}}
\newcommand\mykeywords{{{Math},{Matemática},{AM 2C},{Anotações}}}
...
\begin{luacode*}
    ...
    dir = "./"
    -- Prefix and sufix
    prefix = "AM_2C-Slides_Anotações.2023."
    sufix  = ""
    -- Print file range
