% !TEX root = ./AM_2C-Anotações.1.tex
\providecommand\mainfilename{"./AM_2C-Anotações.tex"}
\providecommand \subfilename{}
\renewcommand   \subfilename{"./AM_2C-Anotações.1.tex"}
                ...
                \begin{axis}
                    ...
                    \addplot3 [
                        ...
                        colormap = {cool}{
                            ...
                            color=(green!40!White);
                            color=(green!90!White)
                        },
                        % Scope
                        data cs = cart, % cart/polar/polarrad
                        samples = 2,
                    ...
                    \addplot3 [
                        ...
                        % green,
                        colormap = {cool}{
                            % color(0cm)=(green!20!White);
                            % color(1cm)=(green!40!White);
                            color=(green!90!White);
                            color=(green!90!White)
                        },
                        % Scope
                    ...
                    %         color(1cm)=(blue!40!White);
                    %         color(2cm)=(blue!90!White)
                    %     },
                    %     % Scope
                    %     data cs = cart, % cart/polar/polarrad
                    %     samples = \mysampledensitySimple,
...
\begin{sectionBox}1m{Parabolas e Paraboloides}
...
\begin{sectionBox}1m{Elipse e Elipsóides}
