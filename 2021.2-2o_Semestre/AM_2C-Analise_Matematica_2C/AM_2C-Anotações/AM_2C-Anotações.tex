...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{AM\,2C -- Anotações}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações feitas estudando AM 2C, inclui slides e outros materiais}}
\newcommand\mykeywords{{{AM 2C}, {Anotações}, {Math}, {Matemática}, {2022.1}}}
