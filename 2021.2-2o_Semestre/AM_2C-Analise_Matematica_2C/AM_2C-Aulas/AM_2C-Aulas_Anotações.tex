% !TEX root = ./AM_2C-Aulas_Anotações.tex
...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{AM\,2C -- Anotações das Aulas}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações das aulas de AM\,2C}}
\newcommand\mykeywords{{{AM 2C}, {Math}, {Matemática}, {Anotações}}}
...
\begin{luacode*}
    ...
    dir = "./"
    -- Prefix and sufix
    prefix = "AM_2C-Aulas_Anotações."
    sufix  = ""
    -- Print file range
    firstFile = 2 -- first file number
    lastFile  = 5 -- last  file number
