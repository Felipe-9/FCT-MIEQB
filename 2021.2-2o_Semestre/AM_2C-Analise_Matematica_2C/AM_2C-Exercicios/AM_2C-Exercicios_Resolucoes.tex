...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{AM 2C - Exercicios Resoluções}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resoluções dos exercicios de análize matemática 2C}}
\newcommand\mykeywords{{{AM 2C}, {Math},{Matemática},{Exercicses}}}
...
\begin{luacode*}
    ...
    dir = "./"
    -- Prefix and sufix
    prefix = "AM_2C-Exercicios_Resolução.2023."
    sufix  = ""
    -- Print file range
