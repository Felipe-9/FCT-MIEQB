...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{AM 2C -- Testes Anotações}}
% \newcommand\myauthor  {{Felipe B. Pinto 61387 -- EQB}}
\newcommand\myauthor  {{Felipe B. Pinto 71951 -- EQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações dos conteúdos dos testes de AM 2C}}
\newcommand\mykeywords{{{AM 2C}, {Math}, {Matemática}, {Tests}, {Anotações}}}
