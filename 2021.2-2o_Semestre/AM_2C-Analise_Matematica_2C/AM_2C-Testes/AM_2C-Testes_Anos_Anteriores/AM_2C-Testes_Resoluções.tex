% !TEX root = ./AM_2C-Testes_Resolucoes.tex
...
\setlist[checklist]{
    left=0mm,
    label={\text{\fboxsep=-.18pt\fbox{\rule{0pt}{1.8ex}\rule{1.8ex}{0pt}}}\hspace{.2em}},
}
\newlist{alternativelist}{enumerate}{1}
\setlist[alternativelist]{label=\alph*)}
...
% Ranges
\DeclareMathOperator\lopen{]}
\DeclareMathOperator\lclosed{[}
\DeclareMathOperator\ropen{[}
\DeclareMathOperator\rclosed{]}
% MathOperators Declarations
\DeclareMathOperator\E{\,E}
\DeclareMathOperator\Jacobian{J}
\DeclareMathOperator\Hessiana{H}
\DeclareMathOperator\Lagrangiana{L}
...
\subfile{./AM_2C-Testes_Resolucoes-2020.2.2}\newpage
\subfile{./AM_2C-Testes_Resolucoes-2021.1.2}\newpage
\subfile{./AM_2C-Testes_Resolucoes-2022.1.1}\newpage
\subfile{./AM_2C-Testes_Resolucoes-2022.1.2}\newpage
\subfile{./AM_2C-Testes_Resolucoes-2022.1.3}\newpage
...
%     -- Prefix and sufix
%     prefix = "AM_2C-Testes_Resolucoes"
%     sufix  = ""
...
%         tex.print(string.split(table.concat{
%         [[
%             \subfile{]], dir, prefix, [[-2021.1.]], string.format("%d", i), sufix, [[}\newpage
%         ]]
%         },"\n"))
%     end
...
%         tex.print(string.split(table.concat{
%         [[
%             \subfile{]], dir, prefix, [[-2022.1.]], string.format("%d", i), sufix, [[}\newpage
%         ]]
%         },"\n"))
%     end
