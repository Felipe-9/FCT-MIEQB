...
\providecommand\mainfilename{"./AM_2C-Testes_Anotacoes.tex"}
\providecommand \subfilename{}
\renewcommand   \subfilename{"./AM_2C-Testes_Anotacoes.2.tex"}
...
\begin{sectionBox}1{Multiplicadores de Lagrange} % S
