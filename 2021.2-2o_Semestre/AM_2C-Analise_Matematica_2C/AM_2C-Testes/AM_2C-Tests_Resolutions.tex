...
\DeclareMathOperator\jacobiana{J}
...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{AM 2C -- Resoluções dos testes e exames}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resoluções dos testes e exames de análize matemática 2C}}
\newcommand\mykeywords{{{AM 2C}, {Math}, {Matemática}, {Tests}}}
