...
\newcommand\mytitle   {{ALGA - Algebra Linear e Geometria Analítica}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações relacionadas a cadeira de ALGA 2021.2; inclui anotações, resoluções de exercícios, testes}}
\newcommand\mykeywords{{{ALGA}, {Math}, {Matemática}, {2o Semestre 2021.2}, {Caderno}}}
...
% Anotações dos slides
\sobpart{Anotações}
\renewcommand\thepart{Slide \arabic{part}}
\begin{luacode*}

    -- Files Directory
    dir = "ALGA - Slides/slides/"
