...
\newcommand\trailingdots{\cftdotfill{\cftdotsep}}
...
\newcommand\mytitle   {{ALGA -- Slides Anotações}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações dos slides de ALGA}}
\newcommand\mykeywords{{{ALGA}, {Math}, {Matemática}, {Anotações}, {2o Semeste 2021.2}}}
...
\renewcommand\theproposition{Proposição \arabic{proposition}}
\renewcommand\theHproposition{\theHpart.\arabic{proposition}}
\newcommand\proposition[1]{
    % add section*
    \refstepcounter{proposition}
    \section*{\theproposition\quad#1}
    % add to toc
    \addcontentsline{toc}{section}{\theproposition\quad#1}
}
...
% propositionBox
\NewDocumentEnvironment{propositionBox}
{
    s       % #1 - Numbered
    t1      % #2 - Question
    t2      % #3 - Subquestion
    ...
    \IfBooleanF{#6}{\noindent\begin{minipage}{\linewidth}}
        \IfBooleanTF{#1}{%
            ...
            \IfBooleanT{#2}{\proposition {#8}\relax}
        }
        \IfBooleanTF{#5}
            { #9 }
            { \begin{tcolorbox}[%
...
\renewcommand\thepart{Slide \arabic{part}}
...
\begin{luacode*}
    ...
    -- Prefix and sufix
    prefix = "ALGA-Slides_Anotacoes."
    sufix  = ""

    
    -- Print file range
    firstFile = 1 -- first file number
    lastFile  = 8 -- last  file number
