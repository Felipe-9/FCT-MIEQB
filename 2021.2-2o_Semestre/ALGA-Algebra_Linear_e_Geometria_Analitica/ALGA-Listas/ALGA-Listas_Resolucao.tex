% !TEX root = ./ALGA-Listas_Resolução.tex
...
\newcommand\mytitle   {{ALGA -- Listas Resolução}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resolução das listas de ALGA}}
\newcommand\mykeywords{{{ALGA}, {Math}, {Matemática}, {Resolutions}}}
