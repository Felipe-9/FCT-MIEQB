...
\newcommand\mytitle   {{ALGA - Anotações das Aulas}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações das aulas de Algebra Linear e Geometria Analítica}}
\newcommand\mykeywords{{{ALGA}, {Math}, {Matemática}, {2021.2 - 2o Semestre}}}
...
\begin{luacode*}
    ...
    -- Files
    files = {
        "1 2021:10:07", -- Introdução à Cadeira e a matéria
        "2 2021:10:12", -- ...
        "3 2021:10:18", -- Transformações Elementáres
        "4 2021:10:19", -- Matriz em forma escada
    }
