% !TEX root = ./ALGA-Fichas_formativas_resoluções.tex
...
\begin{luacode*}
    ...
    -- Prefix and sufix
    prefix = "ALGA-Fichas_formativas_resoluções."
    sufix  = ""
...
% mytitle and myauthor
\newcommand\mytitle   {{ALGA - Fichas Formativas: Resolução}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resolução das fichas normativas da cadeira de Algebra Linear e Geometria Analítica (ALGA)}}
\newcommand\mykeywords{{{ALGA}, {Math}, {Matemática}, {2021.2 - 2o Semestre}, {Resolução}}}
...
\renewcommand\thesubsubsection{(\roman{subsubsection})}
\renewcommand\thepart{Ficha Formativa \arabic{part}}
...
\begin{luacode*}
    ...
    do
        tex.print(string.split(table.concat{
        [[
            \input{]], dir, prefix, files[i], suffix, [[}\newpage
        ]]
        },"\n"))
    end
