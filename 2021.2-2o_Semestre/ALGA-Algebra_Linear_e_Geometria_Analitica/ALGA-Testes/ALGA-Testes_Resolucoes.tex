...
% pgf
    ...
    %     % Color Map
    %     colormap = {cool}{
    %         color=(DarkGreen\Light!20!Black);
    %         % color=(DarkGreen\Light!60!Black);
    %         color=(DarkGreen\Light!70!Black);
    %         % color=(DarkGreen\Light!80!Black);
    %         color=(DarkGreen\Light!90!Black)
    %     },
    %     % Legend
    %     legend style = {
    %         draw         = none,
...
\NewDocumentCommand\mymakesubfile{
    ...
    \ifSubfilesClassLoaded{
        ...
        \stepcounter{part}
        \IfBooleanTF{#1}
            {\renewcommand\mytitle{\IfValueT{#3}{#3 -- }#4 -- \thepart\IfValue{#5}{: #5}}}
            {\renewcommand\mytitle{\IfValueT{#3}{#3 -- }#4}}
        \mymaketitle
    }{
        % main
        \part{#5}
...
% !TEX root = ./ALGA_-_Testes_Resoluções.tex
% !TEX root = ./ALGA_-_Teste_1_Resolução.tex
% !TEX root = ./ALGA_-_Exame_1_Resolução.tex
\documentclass{article}
...
% mytitle and myauthor
\newcommand\mytitle   {{ALGA -- Testes Resoluções.tex}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resoluções dos testes e exames de ALGA}}
\newcommand\mykeywords{{{ALGA}, {Math}, {Matemática}, {2021.2 - Segundo Semestre}, {Resoluções}}}
...
% Exames
\renewcommand\thepart{Exame \arabic{part}}
\begin{luacode*}
