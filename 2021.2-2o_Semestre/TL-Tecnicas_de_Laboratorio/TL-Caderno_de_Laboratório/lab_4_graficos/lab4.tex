...
\geometry{
    ...
    a5paper,
    top       = .01\paperheight,
    bottom    = .01\paperheight,
    left      = .00001\paperwidth,
    right     = .00001\paperwidth,
    portrait  = true,
}
...
% pgf
    ...
    \pgfplotsset{
        compat       = newest,
        width        = .70\pagewidth,    % width
        height       = .23\pageheight,    % height
...
% \colorlet{LegendColor}{]], legendcolor[i], [[}

\begin{tikzpicture}

    \begin{axis}[
        title=Destilação simples n-hexano/diclorometano(2:1),
        height= .5\pageheight,
        % legend style={
        %     fill= LegendColor\Light\Dark,
        %     fill opacity= 0.5,
        %     text opacity= 1,
        %     draw= none
        %     },
        % extra x ticks= {]], extraticks[i], [[},
        xlabel=	{Volume (\unit{\milli\litre})},
        ytick distance= 5,
        xtick distance= 4,
        y tick label style={
            /pgf/number format/.cd,
    ...
    % \addlegendentry[LegendColor\Light]{]], chem[i], [[}
...
\begin{tikzpicture}
    ...
    \begin{axis}[
        title={
            \begin{tabular}{c}
                Destilação fracionada n-hexano/diclorometano(2:1)
            \\  parte 1
            \end{tabular}
        },
        % legend style={
    ...
    \addplot[Black, mark=*] table[
        ...
        y index=1,
        % point meta=x
    ]   {data/destilacao_fracionada_1.csv};
...
\begin{tikzpicture}
    ...
    \addplot[Black, mark=*] table[
        ...
        y index=1,
        % point meta=x
    ]   {data/destilacao_fracionada_2.csv};
