...
\usepackage{ghsystem}    % not avalible in portuguese
    \ghssetup{
        language=english,
        pic-type=png
    }
...
\newcommand\mytitle   {{TL - Caderno de Laboratório}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Caderno de laboratório das aulas de técnicas de laboratório (TL)}}
\newcommand\mykeywords{{{TL}, {Chemistry}, {Química}, {2021.2 - 2o Semestre}}}
...
\pagestyle{fancy}
\lhead{\normalsize\myauthor}
\rhead{\normalsize\arabic{part}.\arabic{section}}
...
\input{recursos/segurança}

% \newpage

% \input{recursos/tabela_ghs}
