...
\sisetup{
    ...
    round-mode             = figures,        % figures/places/none
    round-precision        = 4,
...
\newcommand\mytitle   {{TL - Anotações dos Slides}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações dos slides de TL}}
\newcommand\mykeywords{{{TL}, {Chemistry}, {Química}, {2021.2 2o Semestre}, {Anotações}}}
