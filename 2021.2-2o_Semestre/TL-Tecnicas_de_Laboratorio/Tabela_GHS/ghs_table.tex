...
\geometry{
    ...
    % papersize = {200mm, 275mm},
    % a4paper,  % {210mm, 297mm}, % (√2:1 ) A4
    a5paper, % (√2:1 ) A5
    % a5paper
    top       = .02\paperheight,
    bottom    = .015\paperheight,
    left      = .015\paperwidth,
    right     = .015\paperwidth,
    % % % 200 x 275
    % top       = .04\paperheight,
...
\newcommand\mytitle   {{Tabela GHS}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Tabela de códigos do sistema de segurança Global Harmonized System (GHS)}}
\newcommand\mykeywords{{{TL}, {Chemistry}, {Química}, {2o Semestre - 2021.2}}}
...
\begin{longtable}{lclc}
    ...
    \toprule
        ...
        \normalfont\bfseries name & \bfseries pictogram \\
    \midrule\endhead
    \bottomrule\multicolumn{4}{c}{\hfill\textit{continues on next page}}\endfoot
    ...
    bottle          & \ghspic{bottle}          & bottle-2-white  & \ghspic{bottle-2-white} \\
    bottle-2-black  & \ghspic{bottle-2-black}  & & \\
...
% \begin{tcolorbox}[breakable]
    \ghslistall[
        ...
        table-top-head-rule  = {booktabs},
        table-head-rule      = {booktabs},
        table-foot-rule      = {booktabs},
        table-last-foot-rule = {booktabs}
    ]
% \end{tcolorbox}
