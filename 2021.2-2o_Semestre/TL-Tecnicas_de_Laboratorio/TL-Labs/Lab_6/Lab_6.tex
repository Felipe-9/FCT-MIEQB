...
\renewcommand\thepart{\arabic{part}.3}
\setcounter{part}{5}
\part{Análize}

\begin{questionBox}*1{Massa total de Cafeína}
    \begin{flalign*}
        &
            m_c\,\unit{\gram\of{Cafeína}}
        =   \frac{10\,\unit{\gram\of{Cafeína}}}{\unit{\litre\of{Sol. Caf.}}}
        \,  50.0\,\unit{\milli\litre\of{Sol. Caf.}}
        =
            \qty{500}{\milli\gram\of{Cafeína}}
        &
    \end{flalign*}
\end{questionBox}

\begin{questionBox}*1{Massa total de cafeína extraída nos 3 processos}
    \begin{flalign*}
        &
            m_t\,\unit{\gram\of{Cafeína}}
        =   ((58.25-57.80)+(58.26-57.94)+(58.83-58.69))\,\unit{\gram\of{Cafeína}}
        = &\\&
        =   (0.45+0.32+0.14)\,\unit{\gram\of{Cafeína}}
        =   0.91\,\unit{\gram\of{Cafeína}}
        &
    \end{flalign*}

    \paragraph{Obs:} Curiosamente a massa de cafeína extraída é superior a total da amostra disso podemos gerar 2 hipóteses:
    \begin{itemize}
        \item Erro nas medições de massa, apesar de ser o erro mais esperádo pela forte relação entre as 3 medições todas deveriam estar erradas o que é improvável.
        \item Valor incorreto da concentração de cafeína na solução inicial com valor real por volta de \(20\,\unit{\gram\of{Cafeína}\per\litre}\)
    \end{itemize}

\end{questionBox}

\begin{questionBox}*1{Supondo segunda hipótese}

    Rendimentos por concentração de cafeína atual em cada etapa das extrações.

    \begin{questionBox}*2{Rendimento 1 extração (30\,\unit{\milli\litre\of{\ch{CH2Cl2}}})}
        \begin{flalign*}
            &
            =   \frac{58.25-57.80}{1.00}
            \cong
                \qty{45}{\percent\gram/\gram}
            &
        \end{flalign*}
    \end{questionBox}

    \begin{questionBox}*2{Rendimento 2 extrações (15\,\unit{\milli\litre\of{\ch{CH2Cl2}}})}
        \begin{flalign*}
            &
            =   \frac{58.26-57.94}{1.00-(58.25-57.80)}
            \cong
                \qty{58.1818181818182}{\percent\gram/\gram}
            &
        \end{flalign*}
    \end{questionBox}

    \begin{questionBox}*2{Rendimento 3 extrações (10\,\unit{\milli\litre\of{\ch{CH2Cl2}}})}
        \begin{flalign*}
            &
            =   \frac{58.83-58.69}{1.00-(58.25-57.80)-(58.26-57.94)}
            \cong
                \qty{60.8695652173913}{\percent\gram/\gram}
            &
        \end{flalign*}
    \end{questionBox}

    \begin{questionBox}*2{Conclusão}

        Temos por conclusão que o rendimento da extração está diretamente associado a quantidade de etapas de extração.
