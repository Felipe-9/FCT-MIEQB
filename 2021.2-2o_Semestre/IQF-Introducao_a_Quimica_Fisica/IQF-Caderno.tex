...
% \renewcommand\cftsecafterpnum{\hspace{0.5em}}
% \setlength\cftsecnumwidth{\cftsecafterpnum}         % Fix section width
...
% \setlength\premulticols{0.8\textheight}
...
\newcommand\mytitle   {{IQF -- Introdução a Química-Física}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Todo material relacionado a cadeira de IQF; Contem anotações, exercícios e resolução de testes}}
\newcommand\mykeywords{{{IQF}, {Chemistry}, {Química}, {2o Semestre 2021.2}, {Caderno}}}
...
% \sobpart{Anotações}
% \renewcommand\thepart{Slide \arabic{part}\hspace{0.5em}--\hspace{0.5em}}
% \begin{luacode*}
%
%     -- Files Directory
%     dir = "IQF - Slides/"
...
%         "2", -- Introdução à Química-Física
%         "3", -- Calorimetria e 1a Lei da Termodinâmica
%         -- "4", --
%     }
%
%     -- Print some files
...
% \sobpart{Listas de Exercícios}
% \renewcommand\thepart{Lista \arabic{part}}
% \begin{luacode*}
%
%     -- Files Directory
%     dir = "IQF - Listas/resolucoes/"
%
%     -- Prefix
%     prefix = "resolucao L"
%
...
\sobpart{Minitestes no moodle}
\renewcommand\thepart{Miniteste \arabic{part}}
\renewcommand\thesection{Tentativa \arabic{section}}
\begin{luacode*}

    -- Files Directory
    dir = "IQF - MiniTestes Moodle/"
