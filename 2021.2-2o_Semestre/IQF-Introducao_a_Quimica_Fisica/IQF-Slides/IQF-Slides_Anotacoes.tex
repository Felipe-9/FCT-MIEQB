...
\newcommand\mytitle   {{IQF - Anotações dos Slides}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações dos slides da cadeira de IQF da FCT}}
\newcommand\mykeywords{{{IQF}, {Chemistry}, {Química}, {Anotações}, {2o Semestre 2021.2}}}
...
\renewcommand\thepart{Slide \Roman{part}}
...
\begin{luacode*}
    ...
    for i=1,4,1 -- Print range
    do
        tex.print(string.split(table.concat{
        [[
            \input{]], dir, prefix, i, sufix, [[}\newpage
        ]]
        },"\n"))
    end

    for i=15,15,1 -- Print range
    do
        tex.print(string.split(table.concat{
        [[
            \input{]], dir, prefix, i, sufix, [[}\newpage
