...
\newcommand\mytitle   {{IQF - Resoluções dos testes}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resoluções dos testes de IQF}}
\newcommand\mykeywords{{{IQF}, {Chemistry}, {Química}, {2021.2 - 2o Semestre}, {Teste}, {Resolução}}}
