...
\newcommand\mykeywords{{{IQF}, {Chemistry}, {Química}, {2o Semestre - 2021.2}, {Exercícios}}}
...
\begin{questionBox}1m{}
    ...
    \vspace{2ex}
    \begin{center}
        \ch{ NH4CO2NH2\sld{} <-> 2 NH3\gas{} + CO2\gas{}}
    \end{center}
    ...
    \begin{questionBox}3{}
        \begin{flalign*}
            &
                P_{eq\,\ch{NH3\gas{}}}
            =   P_{eq\,Total}*\frac{2}{3}\,\unit{\bar}
            \cong
                \qty{1.2655333333}{\bar}
            &
        \end{flalign*}
    \end{questionBox}\relax
    ...
    \begin{questionBox}3{}
        \begin{flalign*}
            &
                P_{eq\,\ch{CO2\gas{}}}
            =   P_{eq\,Total}*\frac{1}{3}\,\unit{\bar}
            \cong
                \qty{0.6327666667}{\bar}
            &
        \end{flalign*}
    \end{questionBox}
    ...
    \begin{questionBox}3{}
        \begin{BM}
            x\,\unit{\mole\of{\ch{NH4CO2NH2\sld{}}}}:vol_{eq}=3.00\,\unit{\deci\meter^3}
        \end{BM}
        \begin{flalign*}
            &
                x\,\unit{\mole\of{\ch{NH4CO2NH2\sld{}}}}
            \cong
                \frac
                    {\qty{1.013423032309185}{\mole\of{\ch{NH4CO2NH2\sld{}}}}}
                    {\unit{\mole\of{\ch{NH4CO2NH2\sld{}} Decomp.}}}
            \,  \frac
                    {\unit{\mole\of{\ch{NH4CO2NH2\sld{}} Decomp.}}}
                    {\unit{\mole\of{\ch{CO2\gas{}}}}}
            &\\&
                \frac
                    {\num{8.3145}*(50+273.15)\,\unit{\mole\of{CO2\gas{}}}}
                    {\num{0.6327666667}*10^5*(3.00\,\unit{\deci^3})}
            \cong
                \qty{14.343866037066827}{\mole\of{\ch{NH4CO2NH2\sld{}}}}
            &
        \end{flalign*}
    \end{questionBox}
