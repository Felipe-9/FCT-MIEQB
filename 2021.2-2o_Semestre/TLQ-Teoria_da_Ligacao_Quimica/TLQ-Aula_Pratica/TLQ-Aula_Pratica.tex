...
\newcommand\mytitle   {{TLQ - Aula Prática}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Aula prática da cadeira de TLQ de 2021.2}}
\newcommand\mykeywords{{{TLQ}, {Chemistry}, {Química}, {2o Semestre 2021.2}, {Resolução}}}
...
% \renewcommand\thepart{Part \Roman{part}\hspace{.3em}--\hspace{.3em}}
...
% print files
\input{TLQ - Aula Prática Exercícios Resolução.tex}
