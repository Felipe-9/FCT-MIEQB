...
\newcommand\mytitle   {{TLQ - Teoria da Ligação Química}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Todo material relacionado a cadeira de TLQ; inclui anotações, exercícios, resolução de testes...}}
\newcommand\mykeywords{{{TLQ}, {Chemistry}, {Química}, {2o Semestre 2021.2}, {Caderno}}}
