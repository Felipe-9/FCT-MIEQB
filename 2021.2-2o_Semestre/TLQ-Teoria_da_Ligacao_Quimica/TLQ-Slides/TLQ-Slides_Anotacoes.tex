...
\newcommand\mytitle   {{TLQ - Anotações dos Slides}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resumo de TLQ com base nos slides da cadeira}}
\newcommand\mykeywords{{{TLQ}, {Chemistry}, {Química}, {2o Semestre 2021.2}, {Anotações}}}
...
\renewcommand\thequestion{Exemplo \arabic{question}}
...
\renewcommand\thesubquestion{E\arabic{question}.\arabic{subquestion})}
...
\newcommand\HOMO{\textcolor{green\Light}{HOMO}}
\newcommand\LUMO{\textcolor  {red\Light}{LUMO}}
...
\begin{luacode*}
    ...
    -- Print file range
    firstFile = 20 -- first file number
    lastFile  = 22 -- last  file number
    ...
    for i=1,2,1 -- Print range
    do
        tex.print(string.split(table.concat{
        [[
            \input{]], dir, prefix, string.format("%02d", i), sufix, [[}\newpage
        ]]
        },"\n"))
    end
