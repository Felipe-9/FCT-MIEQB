...
\newcommand\mytitle   {{TEQB -- Resolução dos Exercícios}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resolução dos exercícios de TEQB}}
\newcommand\mykeywords{{{TEQB},{Chemistry},{Química},{Resoluções},{2022.2}}}
