% !TEX root = ./TEQB-Testes_Resoluções.tex
...
\usepackage[super]{nth-pt} % cardinals 1st, 2nd...
...
\begin{luacode*}
    ...
    tex.print(string.split(table.concat{
        [[
            \subfile{]], dir, prefix, [[2019.2.1]], sufix, [[}\newpage
        ]]
    },"\n"))
    ...
    do
        tex.print(string.split(table.concat{
        [[
            \subfile{]], dir, prefix, [[2022.2.]], string.format("%d", i), sufix, [[}\newpage
        ]]
        },"\n"))
    end
