% !TEX root = ./QOG-Exercises_Resolutions.tex
...
% \DeclareMathOperator\Primitive{\mathcal{P}}
...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{QOG -- Resolução Exercícios}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resolução dos exercicios das listas de QOG de 2022.2}}
\newcommand\mykeywords{{{QOG},{Química},{Chemistry},{Resoluções},{2022.2}}}
...
\begin{luacode*}
    ...
    dir = "./"
    -- Prefix and sufix
    prefix = "QOG-Exercises_Resolutions.2022."
    sufix  = ""
    -- Print file range
