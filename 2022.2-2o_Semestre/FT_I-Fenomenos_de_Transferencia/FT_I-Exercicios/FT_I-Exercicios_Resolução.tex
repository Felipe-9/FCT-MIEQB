% !TEX root = ./FT_I-Exercicios_Resolução.tex
...
\geometry{
    ...
    papersize = {240mm, 640mm}, % ( 4:3 ) SVGA x 0.4
...
\newcommand\mytitle   {{FT\,I Resolução Exercícios}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resolução dos Exercicios das listas de FT I}}
\newcommand\mykeywords{{{FT I}, {Química}, {Chemistry}, {Resoluções}}}
...
\renewcommand\thesubquestion{Q\arabic{part}\,--\,\arabic{question} \alph{subquestion})}
...
\begin{luacode*}
    ...
    -- Prefix and sufix
    prefix = "FT_I-Exercicios_Resolução."
    sufix  = ""
