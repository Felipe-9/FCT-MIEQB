...
\begin{questionBox}1m{} % Q3-5
    ...
    \begin{itemize}
        \begin{multicols}{2}
            \item \(\rho_{\text{solução ácido}}=1531\,\si{\kilo\gram/\metre^{3}}\);
            \item \(\mu_{\text{solução ácido}} = 0.065\,\si{\kilo\gram\,\metre^{-1}\,\second^{-1}}\); 
        \end{multicols}
