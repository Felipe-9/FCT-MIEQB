% !TEX root = ./FT_I-Teste_Treino_Resolução.1.tex
% !TEX root = ./FT_I-Exercicios_Resolução.tex
\providecommand\mainfilename{"./FT_I-Exercicios_Resolução.tex"}
\providecommand \subfilename{}
\renewcommand   \subfilename{"./FT_I-Teste_Treino_Resolução.1.tex.tex"}
...
\begin{questionBox}1{} % Q7
    ...
    \begin{flalign*}
        &
            ...
            = 1.3\E-2\,\si{P}
            = 1.3\E-3\,\si{\pascal}
            = 1.3\E-3\,\si{\kilo\gram\,\metre^{-1}\,\second^{-2}}
        &
    \end{flalign*}
