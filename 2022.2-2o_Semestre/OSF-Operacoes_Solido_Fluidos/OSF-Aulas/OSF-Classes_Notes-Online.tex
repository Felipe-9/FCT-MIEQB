...
\RenewDocumentCommand\numrange{
    ...
    \IfValueTF{#1}%
    {\oldnumrange[round-precision={#1}, #2]{#3}{#4}}%
    {\oldnumrange[round-mode={none},#2]{#3}{#4}}%
}
...
\RenewDocumentCommand\qtyrange{
    ...
    \IfValueTF{#1}%
    {\oldqtyrange[round-precision={#1}, #2]{#3}{#4}{#5}}%
    {\oldqtyrange[round-mode={none},#2]{#3}{#4}{#5}}%
}
\NewCommandCopy\oldqty\qty
\RenewDocumentCommand\qty{
    o   % #1 Precision
    O{} % #2 options
    m   % #3 module
    m   % #4 unit
    ...
    \IfValueTF{#1}%
    {\oldqty[round-precision={#1},#2]{#3}{#4}}%
    {\oldqty[round-mode={none},#2]{#3}{#4}}%
}
% ==================== Declaring units =================== %
...
% \RenewDocumentCommand\frac{
%     m
%     t/
%     m
% }{\IfBooleanTF{#2}{{#1}/{#3}}{\frac{#1}{#3}}}
% % ======================================================== %
