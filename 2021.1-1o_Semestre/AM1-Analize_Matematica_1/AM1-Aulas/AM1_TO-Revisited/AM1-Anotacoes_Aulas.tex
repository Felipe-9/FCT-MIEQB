% !TEX root = ./AM1-Anotacoes_Aulas.tex
...
\DeclareMathOperator\vizinhanca{\mathcal{V}}
% =================== Algebra operators ================== %
...
\mymaketitle
% print files
% \subfile{AM1-Anotacoes_Aulas.Apendix.1}\newpage
\begin{luacode*}
    -- Files Directory
    dir = "./"
    -- Prefix and sufix
    prefix = "AM1-Anotacoes_Aulas."
    sufix  = ""
    -- Print file range
    firstFile = 1 -- first file number
    lastFile  = 34 -- last  file number
