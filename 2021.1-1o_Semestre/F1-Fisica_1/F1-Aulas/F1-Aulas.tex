...
%     prefix = ./.build/figures/[main.tex]/graphics/
...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{Anotações Aulas -- Física I}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações das aulas de física I}}
\newcommand\mykeywords{{{Física 1},{F1},{Psysics}}}
