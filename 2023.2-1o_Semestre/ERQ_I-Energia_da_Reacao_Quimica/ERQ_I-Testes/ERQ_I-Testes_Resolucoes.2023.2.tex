...
\begin{questionBox}1{ % Q1
    \begin{itemize}
        \begin{multicols}{2}
            ...
            \item A\,(10\%)
            \item \(T_0=200\,\unit{\celsius}=473.15\,\unit{\kelvin}\)
            \item \(v_0=10\,\unit{\deci\metre^3/\second}=600\,\unit{\litre/\min}\)
            \item gráfico \(X\times T\)
            \item \(C_{p\,A}=C_{p\,B}=5\,\unit{\calorie/\mole.\kelvin}\)
            \item \(C_{p\,I}=12\,\unit{\calorie/\mole.\kelvin}\)
            \item \(k_{d\,(473\,\unit{\kelvin})}=1.17\,\unit{\min^{-1}}\)
            \item \(K_{e\,(473\,\unit{\kelvin})}=40\)
            \item \(Ea=20\,\unit{\kilo\calorie/\mole}\)
...
% Break
    \begin{questionBox}2{ % Q1.3
        ...
        \begin{BM}\color{Emph}
            X_{eq}\cong 0.79
            \quad\land\quad
            T_{eq}\cong 546\,\unit{\kelvin}
        \end{BM}
        % Houve algum erro ao calcular o \(X_{(770\,\unit{\kelvin})}\) portanto para poder prosseguir assumo o valor de 0.6
    \end{questionBox}
...
\begin{questionBox}1{ % Q2
    \begin{itemize}
        \begin{multicols}{2}
            ...
            \item \(V=6\,\unit{\metre^3}\)
            \item Em estado estacionário
            \item \(v_0=6\,\unit{\litre/\min}=360\,\unit{\litre/\hour}\)
            \item \(Y_{A\,0}=0.1\)
            \item \(\adif{H_R}=-100.7\,\unit{\kilo\joule/\mole}\)
            \item \(C_{p\,A}=C_{p\,B}=34.6\,\unit{\joule/\mole.\kelvin}\)
            \item \(C_{p\,I}=75.4\,\unit{\joule/\mole.\kelvin}\)
            \item \(R=\qty{8.314462618}{\joule.\mole^{-1}.\kelvin^{-1}}\)
            \item \(C_{A\,0}=1\,\unit{\M}\)
            \item \(T_0=298\,\unit{\kelvin}\)
            \item \(k_{(298\,\unit{\kelvin})}=0.0227\,\unit{\hour^{-1}}\)
        \end{multicols}
        \item com parede envolvida até 85\% com agua a \(100\,\unit{\celsius}=373\,\unit{\kelvin}\)
    \end{itemize}
} % Q2
% Break
\end{questionBox}\begin{questionBox}{}
