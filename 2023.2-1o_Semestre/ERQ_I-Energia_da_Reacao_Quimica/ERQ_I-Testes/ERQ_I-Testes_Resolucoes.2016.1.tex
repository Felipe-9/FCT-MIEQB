...
\begin{questionBox}1{ % Q1
    A reação reversível \ch{A <> B} é conduzida numa bateria de dois reactores CSTR iguais. O 1º Teste reagente A é alimentado à bateria de reactores numa concentração de 1\,\si{\M}, a um caudal volumétrico de 10\,\si{\litre/\min}. As reacções directa e inversa são elementares e os valores da constante cinética da reacção directa e da conversão de equilíbrio são respectivamente 0.05\,\si{\min^{-1}} e 96\%.
} % Q1
...
\begin{questionBox}1{ % Q2
    A reacção elementar, em fase gasosa, \ch{2 A -> 3 B + C} é conduzida à temperatura de 493\,\si{\kelvin} e à pressão de 7\,\si{\atm} num reactor PFR (\(k = 0.45\,\si{\litre.\mole^{-1}.\second^{-1}}\)). Assumindo que o reagente A é alimentado puro ao reactor, a um caudal volumétrico de 15\,\si{\litre/\second} e que se obtém uma conversão de 90\%, determine:
} % Q2
    \begin{BM}
        P\left(
