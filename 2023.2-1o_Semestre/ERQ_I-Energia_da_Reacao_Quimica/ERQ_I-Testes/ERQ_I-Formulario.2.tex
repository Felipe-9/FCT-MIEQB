...
\begin{sectionBox}1{} % S
    ...
    \begin{BM}
        ...
        X
        =\frac{
            C_{p\,A}+\theta_C\,C_{p\,c}(T-T_0)
        }{
            -\adif{H_R}
        }
        \\
        \varepsilon=Y_{A\,0}\,\delta % (coeff_prod - coeff_reagentes)
    \end{BM}
...
\begin{sectionBox}1{} % S
    ...
    \begin{BM}
        V=F_{A\,0}\int_0^X{\frac{\odif{X}}{-r_A}}
    \end{BM}
    
\end{sectionBox}

\begin{sectionBox}1{Simpson} % S
...
\begin{sectionBox}1{} % S
    ...
    \begin{BM}
        Q^{\circ}
        - F_{A\,0}\sum{\theta_I\,C_{p\,i}(T-T_0)}
        - F_{A\,0}\,\adif{H_R}\,X=0
    \end{BM}
...
\begin{sectionBox}1{} % 
    ...
    \begin{BM}
        R_{(T)}
        = \begin{cases}
            (C_{p\,A}+\theta_I\,c_{p\,I})(T-T_0)
            \quad& \text{Adiabática}
            \\
            \frac{U_A}{F_{A\,0}}(T-T_0)
            +\sum{\theta_i\,C_{p\,i}(T-T_0)}
        \end{cases}
    \end{BM}
