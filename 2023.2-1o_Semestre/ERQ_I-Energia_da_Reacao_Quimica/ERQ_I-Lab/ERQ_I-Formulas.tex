...
%             \,(1-X)^{\alpha}
%             \,(\theta_B-X)^{\beta}
%             -\frac{C_{A\,0}^2\,X^2}{K_e}
%         \right)
%         \begin{cases}
%             \theta_B=C_{B\,0}/C_{A\,0}
%             \\
%             C_{A\,0}\gg C_{B\,0}
%         \end{cases}
%     \end{BM}
...
%             (T_a-T)
%             +(-\adif{H_r})\,k_{T\,R}
%             e^{-\frac{E_a}{R}\,\left(\frac{1}{T}-\frac{1}{T_R}\right)}
%             \left(
%                 C_{A\,0}^2
%                 (1-X_i)(\theta_B-X_i)
%                 -\frac{C_{A\,0}^2\,X_i^2}{
...
\begin{minipage}{1\textwidth}
    \begin{BM}
        -r_{A\,0}
        =k_d\,C_{A\,0}^\alpha\,C_{B\,0}^{\beta}
        ,\ 
        n=\alpha+\beta,\alpha=\beta=1
    \end{BM}
\end{minipage}
