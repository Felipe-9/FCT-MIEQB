...
\begin{sectionBox}1m{Definindo Erros} % S
...
\begin{sectionBox}2m{Definições} % S
  ...
  \begin{BM}
    ...
    \varepsilon_x
    \begin{cases}
      >0,\therefore\hat{x}\text{ é um valor aproximado por \textcolor{\Emph{green}}{defeito}}
      \\
      <0,\therefore\hat{x}\text{ é um valor aproximado por \textcolor{\Emph{red}}{excesso}}
    \end{cases}
  \end{BM}
