...
%     style=numeric
% ]{biblatex}
% \addbibresource{.build/libraries/CM_A-Trabalho.bib}
% \addbibresource{./libraries/CM_A-Trabalho.bib}
...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{CM\,A -- Poliuretanos}}
\newcommand\myauthor  {{Felipe B. Pinto}}
...
\author{\Large
    \begin{tabular}{lcr}
        \toprule
            ...
            \\ Antonio P. Torres &  & LEQB
            \\ Francisco Duarte &  & LEQB
        \\\bottomrule
    \end{tabular}%
}
\date{\Large\today}
...
\bibliography{.build/libraries/CM_A-Trabalho.bib}
