...
\begin{sectionBox}1{Substrate consumption} % S
    ...
    \begin{BM}
        ...
        \\
        \begin{cases}
            (r_s)=\unit{\gram\of{S}/\litre.\hour}
            \\(V_{s\,\max})=\unit{\gram\of{S}/\gram\of{X}.\hour}
            \\(m)=\unit{\gram\of{S}/\gram\of{X}.\hour}\ (\text{maintenance coefficient})
        \end{cases}
    \end{BM}
    ...
    \begin{BM}
        ...
        \\
        \begin{cases}
            (V_s)=\unit{\gram\of{S}/\gram\of{X}.\hour}
        \end{cases}
    \end{BM}
...
\begin{sectionBox}1{Product formation} % S
    ...
    \begin{BM}
        ...
        \\
        \begin{cases}
            (r_P)=\unit{\gram\of{P}/\litre.\hour}\,\text{(volumetric product production rate)}
            \\ (v_P)=\unit{\gram\of{P}/\gram\of{X}.\hour}\,\text{(specific product production rate)}
        \end{cases}
    \end{BM}
    ...
    \begin{BM}
        ...
        \\
        \begin{cases}
            (\alpha)=\unit{\gram\of{P}/\gram\of{X}}\,\text{(true yeld coefficient of product formation)}
            \\
            (\beta)=\unit{\gram\of{P}/\gram\of{X}.h}\,\text{(specific product formation rate due to maintenace)}
        \end{cases}
    \end{BM}
...
\begin{sectionBox}1{Mass balance to cell concentration} % S
    ...
    \begin{BM}
        ...
        \begin{cases}
            ...
            \end{aligned}
            \\ (D)=\unit{\hour^{-1}}\ \text{(Dilution rate)}
        \end{cases}
    \end{BM}
...
\begin{sectionBox}1{Product Production} % S
    ...
    \begin{BM}
        ...
        \begin{cases}
            (D\,P)
            =\unit{\gram\of{P}/\litre.\hour}
            \,\text{(Volumetric Productivity)}
            \\
            (V_P)
            = \unit{\gram\of{P}/\gram\of{X}.\hour}
    ...
    \end{BM}
    \begin{description}
        \item[\(r_p\)] volumetric rate of production formation (\unit{\gram\of{P}/\litre.\hour})
    \end{description}
...
\begin{sectionBox}1{Definition} % S
    ...
    \begin{description}[
        leftmargin=!,
        labelwidth=\widthof{\((F)=\unit{\metre^3/\hour}\)} % Longest item
    ]
        \item[\((z)=\unit{\metre}\)] 
...
\begin{sectionBox}1{Productivity} % S
    ...
    \begin{BM}
        ...
        = D\,P(z=L)
        \\
        (\text{Prod})=\unit{\gram\of{P}/\litre.\hour}
    \end{BM}
