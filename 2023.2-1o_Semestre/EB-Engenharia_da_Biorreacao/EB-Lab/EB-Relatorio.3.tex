...
\begin{sectionBox}1bm{Determinar o valor de \(k'_{L\,a}\) de transferencia de Oxigênio no meio biológico antes da inoculação} % S1
    ...
    \begin{BM}*
        C_{\ch{O2}}^*
        =1.16
        \,\frac{\si{\milli\mole\of{\text{Ar}}}}{\si{\litre}}
        \,\frac{\num{20.946}\,\si{\milli\mole\of{\ch{O2}}}}{100\,\si{\milli\mole\of{\text{Ar}}}}
        \,\frac{32\,\si{\milli\gram}}{\si{\milli\mole}}
        \cong
        \SI{7.7751552}{\milli\gram/\litre}
    \end{BM}
    Obtendo um valor de \SI{7.7751552}{\milli\gram/\litre}.
    ...
    \begin{center}
        ...
        \begin{axis}
            ...
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(k'_{L\,a}\cong\SI{2.00513034376008}{\min^{-1}}\)}
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(C_{\ch{O2}}^*\cong\SI{6.294565261056239}{\milli\gram\of{\ch{O2}}/\litre}\)}
    ...
    Do gráfico obtivemos que o valor de \(k'_{L\,a}\) é \SI{2.00513034376008}{\min^{-1}} e que o valor de \(C^*\) é de \SI{6.294565261056239}{\milli\gram\of{\ch{O2}}/\litre}.\par
    ...
    \begin{center}
        ...
        \begin{axis}
            [
                ...
                % domain=0:4,
                xlabel={\(t/\si{\min}\)},
                ylabel={\(Q_{\ch{O2}/(\si{\milli\gram/\litre.\min})}\)},
...
\begin{sectionBox}1bm{
    ...
    \begin{center}
        ...
        \begin{axis}
            ...
            % \addlegendentry[Graph]{\(R^2=\num{0.98402378277518}\)}
            % \addlegendimage{empty legend}
            % \addlegendentry[foreground]{\(\mu_{\max}=\SI{5.75777459936e-3}{\min^{-1}}\)}
            % \addlegendimage{empty legend}
            % \addlegendentry[foreground]{\(x_{\max}=\SI{754.73304}{\milli\gram/\litre}\)}
    ...
    \begin{sectionBox}2bm{Método de Malthus} % S
        ...
        \begin{axis}
            [
                ...
                % domain=0:4,
                xlabel={\(t/\si{\min}\)},
                ylabel={\(\ln{x}/(\si{\milli\gram/\litre})\)},
                % legend cell align={left},
            ]
            % Legends
            \addlegendimage{empty legend}
    ...
    \begin{sectionBox}2bm{Método de Euler} % S
        ...
        \begin{axis}
            ...
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(\mu_{\max}\cong\SI{3.24982538479515e-2}{\min^{-1}}\)}
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(x_{\max}\cong\SI{869.23326308339637}{\milli\gram/\litre}\)}
    ...
    \begin{sectionBox}2bm{Método dos 3 pontos} % S
        ...
        \begin{axis}
            ...
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(\mu_{\max}\cong\SI{2.15405950243889E-02}{\min^{-1}}\)}
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(x_{\max}\cong\SI{863.015205640127524}{\milli\gram/\litre}\)}
    ...
    \begin{sectionBox}2bm{Método Polinômial} % S
        ...
        \end{tikzpicture}
        \captionof{figure}{
            Grafico \(X/(\si{\milli\gram/\litre})\times t/\si{\min}\) apresentando o método polinomial com um polinômio de 3º grau, pelo método polinomial \(\odif{x}/\odif{t}=y\).
        }
        \end{center}
        ...
        \begin{axis}
            ...
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(\mu_{\max}\cong\SI{1.72895716874992E-02}{\min^{-1}}\)}
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(x_{\max}\cong\SI{933.979115306908807}{\milli\gram/\litre}\)}
    ...
    Sendo assim, a velocidade de crescimento celular máxima observada é \(0.0215\,\si{\min^{-1}}\) e a concentração máxima observada é \(863\,\si{\milli\gram\of{X}/\litre}\).
    ...
    \begin{center}
        ...
        \begin{axis}
            [
                ...
                % ytick={50/0,600,...,1100},
                xlabel={\(t/\si{\min}\)},
                ylabel={\(r_{\ch{O2}}/(\si{\milli\gram\of{\ch{O2}}/\litre.\min})\)},
            ]
            % Legends
            \addlegendimage{empty legend}
            \addlegendentry[Graph]{\(V_{\ch{O2}}/(\si{\milli\gram\of{\ch{O2}}/\milli\gram\of{X}.\litre})\)}
            \addlegendimage{empty legend}
            \addlegendentry[GraphC]{\(r_{\ch{O2}}/(\si{\milli\gram\of{\ch{O2}}/\litre.\min})\)}
        ...
        \begin{axis}
            [
                ...
                % ymax={1e3},
                % ytick={50/0,600,...,1100},
                ylabel={\(V_{\ch{O2}}/(\si{\milli\gram\of{\ch{O2}}/\milli\gram\of{X}.\litre})\)},
                axis y line*={right},
                axis x line={none},
                % xmin=0,xmax=160,
            ]
    ...
    \begin{center}
        ...
        \begin{axis}
            [
                ...
                % ymax={1e3},
                % ytick={50/0,600,...,1100},
                xlabel={\((C^*-C_L)/\si{\milli\gram\of{\ch{O2}}/\litre}\)},
                ylabel={\(r_{\ch{O2}}/(\si{\milli\gram\of{\ch{O2}}/\litre.\min})\)},
            ]
            % % Legends
            \addlegendimage{empty legend}
            ...
            \addlegendentry[Graph]{\(R^2 = \num{.822671881415277}\)}
            \addlegendimage{empty legend}
            \addlegendentry[foreground]{\(k'_{L\,a} = \SI{3.51769652354435E-01}{\min^{-1}}\)}
    ...
    \begin{center}
        ...
        \begin{axis}
            [
                ...
                % ytick={50/0,600,...,1100},
                xlabel={\(t/\si{\min}\)},
                ylabel={\(r/(\si{\milli\gram/\litre.\min})\)},
            ]
            % Legends
            \addlegendimage{empty legend}
...
\begin{sectionBox}1bm{Estimar o rendimento verdadeiro (\(Y'_{X/S}\)) e o coeficiente de manutenção de acetato e compare com o rendimento observado (\(Y_{X/S}\))} % S
    ...
    \begin{BM}
        ...
        Y_{X/S}
        \cong\frac{\num{846.9537}-\num{531.38796}}{1.9\E6}
        \cong\SI{1.66087231578947368e-4}{\milli\gram\of{X}/\milli\gram\of{S}}
    \end{BM}
    ...
    \begin{center}
        ...
        \begin{axis}
            [
                ...
                % ytick={50/0,600,...,1100},
                xlabel={\(\mu/\si{\min^{-1}}\)},
                ylabel={\(V_{\text{acetato}}/(\si{\milli\gram/\litre.\min})\)},
            ]
            % Legends
            \addlegendimage{empty legend}
