...
\pgfplotsset{table/search path={.build/data/}}
...
% \renewcommand\thetable{Tabela \arabic{tablecounter}:}
...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{Estudo da transferencia de massa gás-liquido em sistemas biológicos}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Report}}
\newcommand\mykeywords{{{EB},{2023.2},{Bioreactors}}}
% ================ title, author and date ================ %
\title{\huge\bfseries\color{Emph}\mytitle}
\author{\Large
    \begin{tabular}{lrc}
        \toprule
            Felipe B. Pinto & MIEQB & 61387
            \\ Rui Azevedo  &  LEQB & 63265
            \\ Andre Crespo & MIEQB & 59742
        \\\bottomrule
    \end{tabular}%
}
\date{\Large27 de novembro de 2023}
% % -------------------------------------------------------- %
% %                         fancyhdr                         %
% % -------------------------------------------------------- %
% \usepackage{fancyhdr}
