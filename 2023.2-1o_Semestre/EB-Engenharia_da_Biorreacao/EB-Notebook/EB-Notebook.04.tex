...
% \graphicspath{{\subfix{./.build/figures/EB-Notebook.04}}}
% \tikzsetexternalprefix{./.build/figures/EB-Notebook.04/graphics/}

\mymakesubfile{4}[EB]
{4 Material Balances} % Subfile Title
{Material Balances} % Part Title

\setcounter{subpart}{5}
\subpart{Stoichiometry of Cell Growth and Production Formation}
...
\begin{exampleBox}1{} % E4.7
  ...
  \begin{flalign*}
    ...
    \begin{Bmatrix}
      ...
      \\  a &=& d / 0.43
      \\  b &=& (16-d)\,0.20
      \\  e &=& \frac{1}{2}(34 + 3\,((16-d)\,0.20) - (16-d)\,1.66)
      \\  2\,a &=& c\,0.27 + 2\,d + e
    \end{Bmatrix}
    % = &\\&
    = \begin{Bmatrix}
    ...
    = c\,0.27 + 2\,d + e
    = &\\&
    = (16-d)\,0.27 + 2\,d + \frac{1}{2}(34 + 3\,((16-d)\,0.20) - (16-d)\,1.66)
    \implies &\\&
    \implies
    d = 
    \frac{
...
\begin{sectionBox}1{Electron Balance} % S4.6.2
  ...
  \emph{Available electrons (\textit{ae})} refers to the number of electrons availabe for transfer to oxygen on combustion of a substance to \ch{CO2\text{, }H2O} and nitrogen-containing compounds.\\[1ex]
  ...
  For the substrate (\ch{C_wH_xO_yN_z}):
  \begin{BM}[align]
    \gamma_S
    = \frac{ae_{S}}{w}
    = \frac{4\,w+x-2\,y-3\,z}{w}
  \end{BM}
...
\begin{sectionBox}1{Theorical Oxygen Demand} % S4.6.5
  ...
  \begin{itemize}
    \begin{multicols}{3}
      \item S: \ch{C_wH_xO_yN_z}
      \item B: \ch{CH_{\alpha}O_{\beta}N_{\gamma}}
      \item P: \ch{C_jH_kO_lN_m}
    \end{multicols}
  \end{itemize}
  \begin{center}
    \ch{
  ...
  \end{center}
  \begin{BM}[align]
    a = \frac{1}{4}(w\,\gamma_S-c\,\gamma_B-f\,j\,\gamma_{P})
    \\\impliedby
    w\,\gamma_{S}
    + a\,\gamma_{\ch{O2}}
    = w\,\gamma_{S}
