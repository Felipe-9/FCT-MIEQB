...
\newcounter{bookone}
\newcounter{booktwo}
\renewcommand\thepart{\arabic{bookone}.\arabic{booktwo}}
\renewcommand\theexample{Example \arabic{bookone}.\arabic{example}}
% 88                                    88
% 88                                    \"\"
% 88
...
\begin{document}
\mymaketitle
\subfile{./EB-Notebook.4.6.tex}
\subfile{./EB-Notebook.12.8.tex}
% print files
% \begin{luacode*}
%   -- Files Directory
%   dir = "./"
