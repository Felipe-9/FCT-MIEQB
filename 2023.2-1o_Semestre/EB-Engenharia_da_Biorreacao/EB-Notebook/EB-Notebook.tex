...
\setlength{\cftsecnumwidth}{04em} % Fix section width
% ======================== subsec ======================== %
...
\newcommand\e[1]{\,\mathrm{e}^{#1}}
\DeclareMathOperator\unitof{unit} % similar to dim, return unit instead of dimention
...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{EB -- Notebook}}
\newcommand\myauthor  {{Felipe B. Pinto 71951 -- EQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Engenharia de biorreatores}}
\newcommand\mykeywords{{{EB}, {FCT-UNL}, {NOVA}, {EQB}}}
...
\renewcommand\thesubpart{{\arabic{part}.\arabic{subpart}}}
\renewcommand\theHsubpart{{\theHpart.\arabic{subpart}}}
\numberwithin{section}{subpart}
\newcommand\subpart[1]{
  % \setcounter{section}{0}
  \refstepcounter{subpart}
  \part*{\thesubpart\quad#1}
  % add to toc
  \addcontentsline{toc}{section}{\thesubpart\quad#1}
}

% Equation
\numberwithin{equation}{part}
\renewcommand\theequation{\arabic{part}.\arabic{equation}}
\renewcommand\theHequation{\arabic{part}.\arabic{subpart}.\arabic{section}.\arabic{equation}}
\renewcommand\theexample{Example \arabic{part}.\arabic{example}}
% 88                                    88
% 88                                    \"\"
% 88
...
\begin{document}
\mymaketitle
\subfile{./EB-Notebook.04.tex}
\subfile{./EB-Notebook.12.tex}
% print files
% \begin{luacode*}
%   -- Files Directory
%   dir = "./"
