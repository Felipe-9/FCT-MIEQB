...
\begin{questionBox}1{ % Q3
    % um micro com form elementar \ch{CH_{1.75}O_{0.45}N_{0.16}} (\(MW=23.19\,\si{\gram/\mole}\)) é usado para prod biom a partir de glicerol \ch{C3H8O3} (\(MW=92.09\,\si{\gram/\mole}\)). A fonte de azo é \ch{NH3}. Consi o cres segue a lei de monod \(\mu_{\max}=0.25\,\si{\hour^{-1}}\text{ e }k_s=0.05\,\si{\gram/\litre}\), e que a manut é desp
    \begin{itemize}
        \item \ch{CH_{1.75}O_{0.45}N_{0.16}} (\(MW=23.19\,\si{\gram/\mole}\))
        \item glicerol \ch{C3H8O3} (\(MW=92.09\,\si{\gram/\mole}\))
    ...
    \begin{questionBox}2{ % Q3.1
        Det exp form 0.51\,\si{\gram\of{P}/\gram\of{S}}. Avalie a ness de amon (rendimento amonia/biomassa) e de oxigenio (rend oxi/biomass) numa base mass
    } % Q3.1
        \answer{}
        \begin{center}\large\ch{
            a C3H8O3 
...
\begin{questionBox}2{ % Q3.2
    % Sabendo q o meio contem 4\%\,\si{(w/v)} de glic e que pretende atingir uma conv de substrato de 98\% num reac 100 L
    \begin{itemize}
