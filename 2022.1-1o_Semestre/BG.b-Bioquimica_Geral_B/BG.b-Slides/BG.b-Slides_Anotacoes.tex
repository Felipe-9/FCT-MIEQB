...
% Palette Secondaries
\colorlet{Emph}  {DarkGreen!60!White}
...
\newcommand\mytitle   {{BG.b - Slides Anotações}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações dos slides da cadeira de BG.b}}
\newcommand\mykeywords{{{BG.b}, {Biologia}, {Biology}, {Química}, {Chemistry}, {2022.1}}}
...
\begin{luacode*}
    ...
    do
        ...
        [[
            \subfile{]], dir, prefix, string.format("%02d", i), sufix, [[}\newpage
        ]]
        },"\n"))
    end
