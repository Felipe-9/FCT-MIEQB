...
\newcommand\mytitle   {{BG.b - Anotações Aulas}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 - MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Anotações das aula de BG.b}}
\newcommand\mykeywords{{{BG.b}, {Química}, {Chemistry}, {Biologia}, {Biology}, {Anotações}}}
...
\begin{luacode*}
    ...
    -- Prefix and sufix
    prefix = "BG.b-Aulas_Anotações.T."
    sufix  = ""

    
    -- Print file range
    firstFile =  3 -- first file number
    lastFile  = 13 -- last  file number
...
\begin{luacode*}
    ...
    -- Prefix and sufix
    prefix = "BG.b-Aulas_Anotações.TP."
    sufix  = ""
