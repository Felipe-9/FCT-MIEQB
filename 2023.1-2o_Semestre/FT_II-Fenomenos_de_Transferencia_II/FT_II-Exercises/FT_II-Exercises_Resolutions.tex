...
% %                         Metadata                         %
% % -------------------------------------------------------- %
\newcommand\mytitle   {{Exercicios Resolução Fenomenos de Transferencia II}}
\newcommand\myauthor  {{Felipe B. Pinto 61387 -- MIEQB}}
\newcommand\mycreator {{Felipe B. Pinto}}
\newcommand\mysubject {{Resolução de exercicios de fenomenos de transferencia 2023.1}}
\newcommand\mykeywords{{{FT II},{Química},{Chem},{2023.1},{MIEQB}}}
...
\begin{luacode*}
    ...
    dir = "./"
    -- Prefix and sufix
    prefix = "FT_II-Exercises_Resolutions."
    sufix  = ""
    -- Print file range
