        ...
        &
            ...
            \left(
                \begin{aligned}
                    &
                    0.332
                    \,\frac{(32\E{4})^{0.5}}{(0.14)^{0.5}}
                    \,(\num{1.39808e-1})^{0.5}
                    % 187.678734571303294
                    &+\\+&
                    2.92\E{-2}
                    \,\frac{(32\E{4})^{0.8}}{(0.14)^{0.8}}
                    \left(
                        (40\E{-2})^{0.8}
                        - (\num{1.39808e-1})^{0.8}
                    \right)
            ...
            \implies
            x_c
            = \frac{Re_{x_c}\,Sc\,\mathscr{D}}{u}
            = \frac{32\E{4}*2.57*51\E{-7}}{30}
            \cong
            \num
            {1.39808e-1}
        &
...
\begin{questionBox}2{ % MARK: Q1.2
    ...
    \begin{flalign*}
        &
            ...
            * 0.332
            * \left(
                \frac{5\E{-2}*30}{2.57*51\E{-7}}
            \right)^{0.5}
            \,2.57^{0.33}
            \cong &\\&
            \cong\mathemph{
                \qty{1.564264415729798428e-2}{\m/\s}
            }
        &
    \end{flalign*}
\end{questionBox}
